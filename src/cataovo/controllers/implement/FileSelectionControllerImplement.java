...
public class FileSelectionControllerImplement implements FileSelectionController {
     ...
     * <p> 
     * The action command <strong>Open Palette</strong> opens a Open dialog selection that permits to select
     * a folder that represents a Palette, wich in essence is a folder containg images of the eggs.
     * </p>
     * <p> 
     * The action command <strong>Select Destination</strong> Folder opens a saving dialog selection
     * that permits to select a folder where the analisys of each processing mode 
     * saves its folder. It should be used with caution because each processing mode 
     * resets the saving folder.
     * </p>
     * <p>
     * The action command <strong>Select Report</strong> opens a Open dialog selection where it 
     * allows to select the report generated by Manual and Automatic processing mods
     * and use them as entry to the Evaluation mode.
     * </p>
     *
